...
@Controller
@RequestMapping(ControllerConstants.URI_REGION)
public class RegionController extends BaseController { 
   ...
   */
	...
	*/
	...
	public String create(@Valid Region uiBizObject, BindingResult bindingResult,
	...
	protected List<SelectItem> suggestItems(String keyword) {
		...
		Page<Region> fetchedObjects = this.businessService.searchObjects(keyword, null);
		for (Region bizObject :fetchedObjects.getContent()) {
	...
	protected String performSearch(SearchParameter params) {
		...
		Page<Region> pageContentData = businessService.search(parameters);
