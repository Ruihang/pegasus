...
@Slf4j
@Controller
@RequestMapping(ControllerConstants.URI_BRX_SCHEDULE)
public class ScheduleController extends BaseController { 
   ...
   */
	...
	public String createForm(Model model) {
		Schedule newBusinessPackage = Schedule
		.builder()
		.build();
	...
	*/
	...
	public String create(@Valid Schedule uiBizObject, BindingResult bindingResult,
	...
	protected List<SelectItem> suggestItems(String keyword) {
		...
		Page<Schedule> fetchedObjects = this.businessService.searchObjects(keyword, null);
		for (Schedule bizObject :fetchedObjects.getContent()) {
	...
	protected String performSearch(SearchParameter params) {
		...
		Page<Schedule> pageContentData = businessService.search(parameters);
